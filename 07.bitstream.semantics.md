...
### AOMedia ITUT T35 payload semantics
...
It is a requirement of the bitstream conformance that the first frame in the display order in a coded video
sequence with apply_grain equal to 1 have update_grain equal to 1.
