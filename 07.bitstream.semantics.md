...
applied to the decoded picture associated with the current message.
...
grain synthesis process in response to the syntax element not matching the decoded picture associated with the current
