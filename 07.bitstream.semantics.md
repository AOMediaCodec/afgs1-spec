...
The values of PiontYValueRef[ i ] and PointYScalingRef[ i ] for all instances of index i are equal to PointYValue[ i ] and PointYScaling[ i ],
respectively, in the film grain parameter set with film_grain_param_set_idx equal to filmGrainParamSetIdxForPrediction.

~~~~~ c
num_y_points = numYPointsInRef
...
cb_mult, cb_luma_mult, and cb_offset in the film grain parameter set indicated by filmGrainParamSetIdxForPrediction.
...
~~~~~ c
num_cb_points = numCbPointsInRef
...
to the variables cr_mult, cr_luma_mult, and cr_offset in the film grain parameter set indicated by film_grain_param_set_idx equal to filmGrainParamSetIdxForPrediction.
...
~~~~~ c
num_cr_points = numCrPointsInRef
