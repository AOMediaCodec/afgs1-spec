...
A video parameter set assocoated with the av1_film_grain_params( ) function is selected, and is assocoated with the output picture. 
...
If afgs1_enable_flag is equal to 1 and apply_grain_flag from the selected film grain parameters set av1_film_grain_params( ) is present and equal to 1, then
