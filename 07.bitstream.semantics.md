...
present color primary, transfer characteristics, matrix coefficients and video full range values.

The value of the cicp_info_present_flag shall be the same for all film grain parameter sets 
