...
It is a requirement of bitstream conformance that chroma_scaling_from_luma is equal to 0 when the reconstructed video is monochrome.
...
It is a requirement of bitstream conformance that num_cb_points is equal to 0 when the reconstructed video is monochrome.
