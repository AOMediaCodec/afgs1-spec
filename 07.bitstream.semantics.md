...
film grain parameters that are used with pictures with different output resolutions.
{:.alert .alert-info }
...
sequence, the first picture in the display order with that value of film_grain_param_set_idx that has apply_grain flag equal to 1
