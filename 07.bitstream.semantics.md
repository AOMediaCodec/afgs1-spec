...
It is a requirement of bitstream conformance that apply_vert_resolution << apply_units_resolution_log2 is equal to the vertical resolution of the decoded frame that this metadata is associated with.

It is a requirement of bitstream conformance that apply_horz_resolution << apply_units_resolution_log2 is equal to the horizontal resolution of the decoded frame that this metadata is associated with.


**Note:** apply_horz_resolution and apply_vert_resolution could alternatively be signaled in fixed points (e.g. f(10) ).
{:.alert .alert-info }
