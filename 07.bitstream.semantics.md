...
value num_y_points_minus1 + 1 in the film grain parameters set film_grain_param_set_idx_for_prediction. Values
...
~~~~~ c
for ( i = 0; i < num_y_points_minus1 + 1; i++ ) {
...
**num_y_points_minus1** plus 1 specifies the number of points for the piece-wise linear
scaling function of the luma component.

It is a requirement of bitstream conformance that num_y_points_minus1 + 1 is less than or equal to 14.
...
**Note:** When chroma_scaling_from_luma is equal to 1, it is still allowed for num_y_points_minus1 + 1 to take values up to 14.
