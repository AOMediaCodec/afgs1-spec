...
are not predicted from scaling functions that belong to other film grain parameter sets in the current
...
It is a requirement of conformance to this specification that num_cb_points_in_ref is less than or equal to 10.
...
using bits_per_cb_scaling_res bits and is in the  [ -(1 << (bits_per_y_scaling_res - 1)),  (1 << (bits_per_y_scaling_res - 1)) - 1 ] range.
...
It is a requirement of conformance to this specification that num_cr_points_in_ref is less than or equal to 10.
...
is signaled using  bits_per_cr_scaling_res bits and is in the  [ -(1 << (bits_per_y_scaling_res - 1)),  (1 << (bits_per_y_scaling_res - 1)) - 1 ] range.
