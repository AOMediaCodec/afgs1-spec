...
When AFGS1 metadata is present in the bitstream, a film grain synthesis module conforming to this version of the specification shall implement a film grain synthesis process that
...
The input to this process is a sequence of the reconstructed pictures and a sequence of associated AFGS1 film grain metadata messages. AFGS1 film grain metadata messages may be contained in an elementary bistream.
