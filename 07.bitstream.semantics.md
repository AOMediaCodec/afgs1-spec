...
point_cb_value[ i ] represents the x (luma value) coordinate for the i-th point of the piecewise linear scaling function.
...
point_cr_value[ i ] represents the x (luma value) coordinate for the i-th point of the piecewise linear scaling function.
...
~~~~~ c
for ( i = 0; i < num_cr_points; i++ )
    point_cr_scaling[ i ] = point_cr_scaling[ i ] + cb_scaling_offset.
~~~~~
